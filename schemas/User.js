...
const userSchema = new Schema({
    phone: {type: Number, desc: '手机号'},
    salt: {type: String, desc: ''},
    encryptedPassword: {type: String, desc: ''},
    name: {type: String, desc: '名字'}
}, {
    collection: 'users', //默认取model name的复数为collection name，该选项用于手动指定collection name
